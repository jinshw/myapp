...
export default class MySorage extends Component {
    ...
    */
    ...
    static _load(key, callBack,callBackCatch) {
        this._load3(key, null, null, callBack,callBackCatch);
    }


    static _load3(key, params, someFlag, callBack,callBackCatch) {
